...
import FencingCustomerIntelligence from '@/components/charts/FencingCustomerIntelligence'
...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'bar' | 'line' | 'heatmap' | 'table' | 'waterfall' | 'bubble' | 'competitive-intelligence' | 'customer-intelligence' | 'customer-intelligence-database' | 'customer-intelligence-pipeline'>('bar')
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Europe Fencing Market'}
              </h2>
            </div>
          </div>
        ...
        {/* Demo Data Notice */}
        <div className="mb-4 px-4 py-2 bg-amber-50 border border-amber-300 rounded-md flex items-start gap-2">
                  ...
                  <nav className="flex items-center -mb-px">
                    ...
                    {viewMode === 'tabs' && (
                      <>
                        ...
                        {isChartVisible('customer-intelligence-pipeline') && (
                          <button
                            onClick={() => setActiveTab('customer-intelligence-pipeline')}
                            className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${
                              activeTab === 'customer-intelligence-pipeline'
                                ? 'border-blue-500 text-blue-600'
                                : 'border-transparent text-black hover:text-black hover:border-gray-300'
                            }`}
                          >
              ...
              <div className="p-6">
                {viewMode === 'tabs' ? (
                  <>
                    ...
                    {activeTab === 'customer-intelligence-pipeline' && (
                      <div id="customer-intelligence-pipeline">
                        <FencingCustomerIntelligence />
                      </div>
                    )}
